...
This reference extends the accepted mobile/PWA design language; it does not replace the permanent Option B2 identity, approved palette, Inter/Cormorant Garamond typography roles, or BlueGreen Guide Wayfinding System. When a visual reference and a factual product/data requirement differ, preserve the factual, safety, verification, and accessibility requirement while matching the reference as closely as practical.
