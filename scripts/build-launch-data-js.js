...
console.log(
  `Wrote ${baseData.length} legacy/base records and configured ${missionBayData.length} Mission Bay pilot places (${activeBaseCount + missionBayData.length} active runtime places).`
);
